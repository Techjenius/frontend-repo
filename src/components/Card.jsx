...
const Card = () => {
  return (
    <div className='lg:w-[1200px] w-full p-10 bg-[#0077FF] rounded-lg shadow-md'>
        ...
        <div className='flex flex-col md:flex-row mt-5 items-center justify-between gap-2'>
            <div className='flex flex-col items-center'>
                <Image src={Employ} alt='employ' className='bg-white p-2 rounded-full shadow-sm w-[200px]' />
                <button className=' px-[20px] py-[10px] bg-white mt-3 text-[#4D94FF] rounded shadow-md hover:opacity-75'>Onboard Employees</button>
            
            </div>
            <div className='flex flex-col items-center'>
                <Image src={Employees} alt='employ' className='bg-white p-2 rounded-full shadow-sm w-[200px]'  />
                <button className=' px-[20px] py-[10px] bg-white mt-3 text-[#4D94FF] rounded shadow-md hover:opacity-75'>Create Task </button>
            
            </div>
            <div className='flex flex-col items-center'>
                <Image src={Revolve} alt='employ' className='bg-white p-2 rounded-full shadow-sm w-[200px]'  />
